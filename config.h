...
static const char *fonts[]          = { "xtf:Source Code Pro:style=Regular:size=11" };
static const char dmenufont[]       = "xtf:Source Code Pro:style=Regular:size=11";
...
static const char *ss[] = { "scrot", NULL };
